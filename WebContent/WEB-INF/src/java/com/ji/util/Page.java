...
import com.ji.common.JAppException;

@XmlRootElement
@SuppressWarnings("serial")
public class Page implements Serializable {
//	public static final Page EMPTY_PAGE = new Page(Lists.EMPTY_LIST, 1, 0, "", "");
...
//		this.endUnitPage = (this.beginUnitPage + this.pageunit - 1);
	...
	public Page(List objects, int currentPage, int totalCount, String condition, String search) {
		this(objects, currentPage, totalCount);
		this.condition = condition;
		this.search = search;
	}

//	public Page(List objects, int currentPage, int totalCount, int pageunit, int pagesize) {
//		this.pageunit = 10;
//		this.pagesize = 10;
//		this.search = "";
//		this.condition = "";
...
//			throw new JAppException( "Page unit or page size should be over 0.");
//		}
...
//	}
	public Page(List objects, int currentPage, int totalCount, int pagesize) {
		this.pagesize = 10;
		this.search = "";
		this.condition = "";
		
		if (pagesize <= 0) {
			throw new JAppException( "Page size should be over 0.");
		}
		this.pageunit = 10;
		this.pageunit = pageunit;
		this.pagesize = pagesize;
