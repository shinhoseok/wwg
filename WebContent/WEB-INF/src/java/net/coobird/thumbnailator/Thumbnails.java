...
watermark(Positions.CENTER, image, opacity);
		...
		public List<File> asFiles(Iterable<File> iterable) throws IOException
		{
			...
			for (ImageSource<T> source : sources)
			{
				...
				{
					System.out.println("asFiles IllegalArgumentException==>");
				  }catch (NullPointerException e) {
						System.out.println("asFiles NullPointerException==>");
						
				  }catch (ArrayIndexOutOfBoundsException e) {
						System.out.println("asFiles ArrayIndexOutOfBoundsException==>");
				
				  }catch (Exception e) {
						System.out.println("asFiles Exception==>");
				  }
			}
