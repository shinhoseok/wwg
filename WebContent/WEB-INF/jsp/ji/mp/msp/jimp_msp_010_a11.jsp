...
%>
<style type="text/css">
.squareList{text-align: center;}
.squareList ul{width: 70%; text-align: center; display: inline-flex;margin-left:10%;}
.squareList ul li{width: 40%;margin-right:6%;box-sizing:border-box;border-radius: 9px;position: relative;padding:14px 20px;}
.squareList ul li:nth-child(2){margin-right:0%;}
.squareList ul li:nth-child(2):after{background:none;width:0px;}
