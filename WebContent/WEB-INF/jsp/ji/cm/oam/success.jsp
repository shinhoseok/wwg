...
/* 프로그램 아이디   : /WEB-INF/jsp/ji/cm/oam/success 
/* 프로그램 이름     : success    
/* 소스파일 이름     : success.jsp
/* 설명              : SYSTEM 회원관리 결과 페이지
/* 버전              : 1.0.0
/* 최초 작성자       : 이금용
/* 최초 작성일자     : 2017-03-08
/* 최근 수정자       : 이금용
...
System.out.println(rtn_Url_T+"::::"+rtn_Url+":::::"+rtn_Msg);	
System.out.println("::::::::::::::::::::::::::::::");	

System.out.println(rtn_Url_R+":::"+rtn_Url_F);	
...
// 결과가 성공인경우
if(pstate.equals("C") || pstate.equals("U") || pstate.equals("D") || pstate.equals("UM")){
	if(!rtn_Msg.equals("") && rtn_Sta.equals(FORWARD_SUCCESS)){
		...
		if(rtn_Url_R.equals("") || rtn_Url_R.equals("N")){
			...
			if(rtn_Url_F.equals("")){
				...
				out.print(HtmlTag.getPopup_msg_gourl("parent", rtn_Url, rtn_Msg));
			}else{
%>
