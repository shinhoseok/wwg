<%--
/*=================================================================================*/
/* 시스템            : 시스템 통계 / 개인정보관련 통계 / 개인정보 다운로드 이력
/* 프로그램 아이디   : /WEB-INF/jsp/ji/cm/sta/jicm_sta_060_s1.jsp
/* 프로그램 이름     : jicm_sta_060_s1
/* 소스파일 이름     : jicm_sta_060_s1.jsp
/* 설명              : 요청분류별
/* 버전              : 1.0.0
/* 최초 작성자       : 이금용
/* 최초 작성일자     : 2019-08-06
...
$(document).ready(function() {
	...
	var cols =[
	           	...
	           	,{label:'다운로드일시' 	,index:'reg_dt'					,name:'reg_dt'    			,align:'center'  	,width:'120'  ,hidden:false  ,sortable:false}
	           	,{label:'수행업무'    	,index:'menu_pstate_nm'			,name:'menu_pstate_nm'    	,align:'center'  	,width:'120'  ,hidden:true  ,sortable:false ,formatter : fmmenu_pstate_nm}
