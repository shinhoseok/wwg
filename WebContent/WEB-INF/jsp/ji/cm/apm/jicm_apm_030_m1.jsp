...
/*=================================================================================*/
/* 시스템            : 결재관리
/* 프로그램 아이디   : /WEB-INF/jsp/ji/cm/apm/jicm_apm_030_m1.jsp 
/* 프로그램 이름     : jicm_apm_030_m1    
/* 소스파일 이름     : jicm_apm_030_m1.jsp
/* 설명              : 결재현황
/* 버전              : 1.0.0
/* 최초 작성자       : 이금용
/* 최초 작성일자     : 2015-05-07
...
%>
				<!--내용시작  -->
					...
					%>
						<%@include file="/WEB-INF/jsp/ji/cm/apm/jicm_apm_030_s1.jsp"%><!-- 리스트 jsp 파일-->
