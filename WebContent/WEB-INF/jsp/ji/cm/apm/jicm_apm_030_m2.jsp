...
/*=================================================================================*/
/* 시스템            : 결재관리
/* 프로그램 아이디   : /WEB-INF/jsp/ji/cm/apm/jicm_apm_030_m3.jsp 
/* 프로그램 이름     : jicm_apm_030_m3    
/* 소스파일 이름     : jicm_apm_030_m3.jsp
/* 설명              : 결재완료함
/* 버전              : 1.0.0
/* 최초 작성자       : 이금용
/* 최초 작성일자     : 2015-06-11
...
%>
			...
			%>
				<%@include file="/WEB-INF/jsp/ji/cm/apm/jicm_apm_030_s2.jsp"%><!-- 리스트 jsp 파일-->
