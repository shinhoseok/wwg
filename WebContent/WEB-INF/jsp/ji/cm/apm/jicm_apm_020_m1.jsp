...
/*=================================================================================*/
/* 시스템            : JRCMS 결재관리
/* 프로그램 아이디   : /WEB-INF/jsp/ji/cm/apm/jicm_apm_020_m1.jsp 
/* 프로그램 이름     : jicm_apm_020_m1  
/* 소스파일 이름     : jicm_apm_020_m1.jsp
/* 설명              : 공통 기본결재선관리 리스트
/* 버전              : 1.0.0
/* 최초 작성자       : 이금용
/* 최초 작성일자     : 2015-04-28
...
%>
				<!--내용시작  -->
					...
					%>
						<%@include file="/WEB-INF/jsp/ji/cm/apm/jicm_apm_020_s1.jsp"%><!-- 리스트 jsp 파일-->
					<%	 
					   }else if(pstate.equals("CF")){
					%>
						<%@include file="/WEB-INF/jsp/ji/cm/apm/jicm_apm_020_a1.jsp"%><!-- 등록 jsp 파일-->
					<%	 
					   }else if(pstate.equals("UF")){
					%>
						<%@include file="/WEB-INF/jsp/ji/cm/apm/jicm_apm_020_u1.jsp"%><!-- 수정 jsp 파일-->			
					<%
					   }
					%>
					<!--내용끝-->