...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({		
	...
	makePopupURL : function(){
		...
		var sPopupUrl = "/KomipoWwg/cmsmain.do?scode=000008&pcode=000047&pstate=CF1&inpcode="+parent.document.forms[0].elements['pcode'].value;
	...
	_getPhotoTag : function(htPhotoInfo){
		...
		var sTag = '<img src="{=sOriginalImageURL}" title="{=sName}" style="max-width:1080px;">';
