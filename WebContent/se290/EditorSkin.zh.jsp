	...
	<div id="smart_editor2_content"><a href="#se2_iframe" class="blind">Writing a shortcut to the area</a>
		<div class="se2_tool" id="se2_tool">
			...
			<ul class="se2_font_type">
				<li class="husky_seditor_ui_fontName"><button type="button" class="se2_font_family" title="font"><span class="husky_se2m_current_fontName">글꼴</span></button>
					<!-- 글꼴 레이어 -->
					<div class="se2_layer husky_se_fontName_layer">
						<div class="se2_in_layer">
							<ul class="se2_l_font_fam">
							<!-- 다국어 처리를 위해서 smarteditor2.js 에 폰트 리스트를 가져오는 부분 주석처리. -->
							<li style="display:none"><button type="button"><span>@DisplayName@<span>(</span><em style="font-family:FontFamily;">@SampleText@</em><span>)</span></span></button></li>
							<li><button type="button"><span>Dotum<span>(</span><em style="font-family:'돋움',Dotum,Sans-serif;">abcd</em><span>)</span></span></button></li>
							<li><button type="button"><span>DotumChe<span>(</span><em style="font-family:'돋움체',DotumChe,Sans-serif;">abcd</em><span>)</span></span></button></li>
							<li><button type="button"><span>Gulim<span>(</span><em style="font-family:'굴림',Gulim,Sans-serif;">abcd</em><span>)</span></span></button></li>
							<li><button type="button"><span>GulimChe<span>(</span><em style="font-family:'굴림체',GulimChe,Sans-serif;">abcd</em><span>)</span></span></button></li>
							<li><button type="button"><span>Batang<span>(</span><em style="font-family:'바탕',Batang,serif;">abcd</em><span>)</span></span></button></li>
							<li><button type="button"><span>BatangChe<span>(</span><em style="font-family:'바탕체',BatangChe,serif;">abcd</em><span>)</span></span></button></li>
							<li><button type="button"><span>Gungsuh<span>(</span><em style="font-family:'궁서',Gungsuh,serif;">abcd</em><span>)</span></span></button></li>
							...
							<li><button type="button"><span>NanumGothic<span>(</span><em style="font-family:'나눔고딕',NanumGothic;">abcd</em><span>)</span></span></button></li>
							<li><button type="button"><span>NanumMyeongjo<span>(</span><em style="font-family:'나눔명조',NanumMyeongjo;">abcd</em><span>)</span></span></button></li>
							<li><button type="button"><span>NanumGothicCoding<span>(</span><em style="font-family:'나눔고딕코딩',NanumGothicCoding;">abcd</em><span>)</span></span></button></li>
							<li><button type="button"><span>NanumBarunGothic<span>(</span><em style="font-family:'나눔바른고딕',NanumBarunGothic;">abcd</em><span>)</span></span></button></li>
							<li><button type="button"><span>NanumBarunPen<span>(</span><em style="font-family:'나눔바른펜',NanumBarunPen;">abcd</em><span>)</span></span></button></li>
							</ul>
						</div>
					</div>
					<!-- //글꼴 레이어 -->
				...
				<li class="husky_seditor_ui_fontSize"><button type="button" class="se2_font_size" title="Font Size"><span class="husky_se2m_current_fontSize">크기</span></button>
					<!-- 폰트 사이즈 레이어 -->
				...
				<li class="husky_seditor_ui_justifyfull"><button type="button" title="양쪽정렬" class="se2_justify"><span class="_buttonRound">bothsides-aligned</span></button></li>
						...
						<div class="se2_in_layer">
							<div class="se2_bx_character">
								...
								<p class="se2_apply_character">
									<label for="char_preview">Selected</label> <input type="text" name="char_preview" id="char_preview" value="®º⊆●○" class="input_ty1"><button type="button" class="se2_confirm"><span>Apply</span></button><button type="button" class="se2_cancel husky_se2m_sCharacter_close"><span>Cancel</span></button>
								</p>
							</div>
						</div>
					</div>
				...
				<li class="image husky_seditor_ui_image" style="display:none;">
					<button type="button" title="Insert Image" class="se2_image"><span>이미지 삽입</span></button>
					<!-- 이미지 삽입 레이어 -->
					<div class="layer husky_seditor_image_layer" style="margin-left:-238px;display:none;">
						<h3>Insert Image</h3>
						<button type="button" class="close" title="이미지 삽입 레이어 Close"><span>이미지 삽입 레이어 Close</span></button>
				...
				<li class="movie husky_seditor_ui_movie" style="display:none;"><button type="button" title="동영상 삽입" class="se2_movie"><span>동영상 삽입</span></button></li>
						...
						<div class="se2_in_layer">
							<div class="se2_bx_find_revise">
								...
								<div class="se2_in_bx_find husky_se2m_find_ui" style="display:block">
									<dl>
									<dt><label for="find_word">Find</label></dt><dd><input type="text" id="find_word" value="스마트에디터" class="input_ty1"></dd>
									</dl>
								...
								<div class="se2_in_bx_revise husky_se2m_replace_ui" style="display:none">
									<dl>
									<dt><label for="find_word2">Find</label></dt><dd><input type="text" id="find_word2" value="스마트에디터" class="input_ty1"></dd>
									<dt><label for="revise_word">Replace</label></dt><dd><input type="text" id="revise_word" value="스마트에디터" class="input_ty1"></dd>
									</dl>
									<p class="se2_find_btns">
		...
		<div class="se2_layer se2_accessibility" style="display:none;">
			<div class="se2_in_layer">
				...
				<div class="box_help">
					<div>
						<strong>툴바</strong>
						<p>ALT+F10 을 누르면 툴바로 이동합니다. 다음 버튼은 TAB 으로 이전 버튼은 SHIFT+TAB 으로 이동 가능합니다. ENTER 를 누르면 해당 버튼의 기능이 동작하고 글쓰기 영역으로 포커스가 이동합니다. ESC 를 누르면 아무런 기능을 실R하지 않고 글쓰기 영역으로 포커스가 이동합니다.</p>
		...
		<div class="se2_input_area husky_seditor_editing_area_container">
			...
			<!-- //입력창 조절 안내 레이어 -->
				...
				<button class="_fold se2_qmax q_open_table_full" style="position:absolute; display:none;top:340px;left:210px;z-index:30;" title="Maximize" type="button"><span>퀵에디터Maximize</span></button>
				<div class="_full se2_qeditor se2_table_set" style="position:absolute;display:none;top:135px;left:661px;z-index:30;">
					<div class="se2_qbar q_dragable"><span class="se2_qmini"><button title="최소화" class="q_open_table_fold"><span>퀵에디터최소화</span></button></span></div>
					<div class="se2_qbody0">
						<div class="se2_qbody">
							<dl class="se2_qe1">
							<dt>삽입</dt><dd><button class="se2_addrow" title="R삽입" type="button"><span>R삽입</span></button><button class="se2_addcol" title="열삽입" type="button"><span>열삽입</span></button></dd>
							<dt>분할</dt><dd><button class="se2_seprow" title="R분할" type="button"><span>R분할</span></button><button class="se2_sepcol" title="열분할" type="button"><span>열분할</span></button></dd>

							<dt>삭제</dt><dd><button class="se2_delrow" title="R삭제" type="button"><span>R삭제</span></button><button class="se2_delcol" title="열삭제" type="button"><span>열삭제</span></button></dd>
							<dt>병합</dt><dd><button class="se2_merrow" title="R병합" type="button"><span>R병합</span></button></dd>
							</dl>
						...
						<div class="se2_qbody0">
							<div class="se2_qbody">
								<div class="se2_qe10">
									...
									<div class="se2_qe10_1"><input type="checkbox" checked="checked" name="" class="se2_srate" id="se2_srate"><label for="se2_srate">가로 세로 비율 유지</label></div>
								</div>
							</div>
						</div>
					</div>
