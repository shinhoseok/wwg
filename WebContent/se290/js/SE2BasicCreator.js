function createSEditor2(elIRField, htParams, elSeAppContainer){
	...
	// smart editor 2.8.2.3 버젼부터 보안 이슈로 인해 client-side xss 필터링 기능이 추가
	// 해당 기능을 사용할 경우 iframe, embed, script등 일부 태그가 필터링 처리 됨
	// 그로 인해 동영상 첨부, code 삽입등이 제한 될 수 있으므로 bSkipXssFilter 옵션을 true로 지정하여 해당 기능을 제외 시킬 수 있음
	// WebEditor bSkipXssFilter style 옵션 (false:사용 / 그외:사용하지 않음)
	...
	SE_RegisterCustomPlugins(oEditor,elAppContainer,htParams);
