...
// var _IMGLIMITTEXT = "<p>한 파일당 " + (_IMGFILESIZE > 0 ? ("최대 <span class='limit_text'>" + Math.ceil(_IMGFILESIZE/1024 * 10)/10 + "MB</span>까지") : "제한없이") + " 올릴 수 있고,<br/>한 번에 여러 개의 파일을 첨부할 수 있습니다.</p>";
<%-- var _IMGCOUNT = "<%=getCount()%>"; --%>
// var _FILECOUNTLIMIT_MSG = "최대 전송 가능한 파일 개수 초과 오류로 인해 취소 되었습니다.";
// var _CLOSE_MSG = "이미지를 추가하지 않고 창을 닫으시겠습니까?";
// var _FILE_EXCEEDS_SIZE_LIMIT = "파일당 최대 용량 초과로 인해 취소 되었습니다.";
// var _ZERO_BYTE_FILE = "0Btye 파일이므로 인해 취소 되었습니다.";
// var _INVALID_FILETYPE =	"업로드 제한된 파일 형태로 인해 취소 되었습니다.";
// var _UNKNOWN = "알수 없는 오류로 인해 로 인해 취소 되었습니다.";
// var _BTNTEXT = "파일추가";
// var _LANG = 'ko_KR';
</script>
</head>
		...
		<div class="se2_tool" id="se2_tool">
			...
			<ul class="se2_font_type">
					...
					<div class="se2_layer" style="margin-left:-285px">
						<div class="se2_in_layer">
							<div class="se2_url2">
								...
								<p><input name="" id="target" type="checkbox" checked="checked" value="" /><label for="target">새창으로</label></p>
				...
				<li class="image husky_seditor_ui_image" style="display:none;">
					<button type="button" title="이미지 삽입" class="se2_image"><span>이미지 삽입</span></button>
					<!-- 이미지 삽입 레이어 -->
					<div class="layer husky_seditor_image_layer" style="margin-left:-238px;display:none;">
						<h3>이미지 삽입</h3>
						<button type="button" class="close" title="이미지 삽입 레이어 닫기"><span>이미지 삽입 레이어 닫기</span></button>
						<div class="upload_area">
							<span class="help_text"></span>
							<span class="upload_btn" id="upload_btn" title="파일추가"></span>
						</div>
